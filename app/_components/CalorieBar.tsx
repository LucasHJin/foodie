  ...
  return (
    <>
      <button
        ...
        className="group flex items-center gap-2.5 bg-white/90 backdrop-blur-md border border-stone-200/80 rounded-full px-4 py-2 shadow-sm shadow-stone-200/50 hover:shadow-md hover:border-stone-300 transition-all"
      >
